...
type LayoutProps = {
 ...
 const Hero: React.FC<LayoutProps> = ({ }) => {
    ...
    <div className='hero md:px-12 md:py-12 px-6 py-6 max-w-[80%] lg:max-w-[67%] text-center mx-auto md:my-9'>
        <h1 className='text-themeblue md:text-7xl text-2xl font-extrabold my-6'>Let's Empower your Next Generation Digital <span className='text-gold'>Product</span> and <span className='text-gold'>Workforce</span> Together </h1>
